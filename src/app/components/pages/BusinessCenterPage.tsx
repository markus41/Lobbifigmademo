...
const ClipboardListIcon = ({ className, style }: IconProps) => (
  <svg className={className} style={style} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
...
const CoffeeIcon = ({ className, style }: IconProps) => (
  <svg className={className} style={style} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
...
const ToolIcon = ({ className, style }: IconProps) => (
  <svg className={className} style={style} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
...
export function BusinessCenterPage({ organization, account: _account }: BusinessCenterPageProps) {
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-4">
          <ServiceCard
            ...
            actions={[
              { label: 'Create Invoice', onClick: () => toast.success('Invoice creation wizard coming soon!') },
              { label: 'View All', onClick: () => toast.info('Viewing all 23 invoices...') },
            ]}
            organization={organization}
          />
          ...
          <ServiceCard
            ...
            actions={[
              ...
              { label: 'Schedule', onClick: () => toast.info('Report scheduling coming soon!') },
            ]}
            organization={organization}
          />
          ...
          <ServiceCard
            ...
            actions={[
              { label: 'Add Vendor', onClick: () => toast.success('Add vendor form coming soon!') },
              { label: 'View All', onClick: () => toast.info('Viewing 24 active vendors...') },
            ]}
            organization={organization}
          />
          ...
          <ServiceCard
            ...
            actions={[
              { label: 'New Order', onClick: () => toast.success('New order form coming soon!') },
              { label: 'Catalog', onClick: () => toast.info('Product catalog coming soon!') },
            ]}
            organization={organization}
          />
        </div>
