  ...
  return (
    <div ref={dropdownRef} className="relative">
      ...
      <button
        ...
        className="w-full px-6 py-4 border rounded-xl text-left cursor-pointer transition-all outline-none bg-white group"
        style={{
          borderColor: isOpen
            ? `rgba(${primaryRgb}, 0.5)`
        ...
        {selectedAccount ? (
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1 min-w-0">
              <div className="text-[14px] font-medium truncate" style={{ color: 'var(--theme-text-primary, #2C2A25)' }}>
      ...
      <AnimatePresence>
        {isOpen && (
          ...
          >
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2">
                        <span className="text-[14px] font-medium" style={{ color: 'var(--theme-text-primary, #2C2A25)' }}>
                      ...
                      <div className="text-[12px] mt-0.5 truncate" style={{ color: 'var(--theme-text-secondary, #8A8578)' }}>
                        {account.email}
                      </div>
                      <div
            ...
            >
              <p className="text-[11px] text-center" style={{ color: 'var(--theme-text-muted, #B8B0A0)' }}>
...
export function EmailSelection({ onEmailSelected }: EmailSelectionProps) {
  ...
  const [_isRecognizing, setIsRecognizing] = useState(false);

  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    if (selectedEmail) {
      setIsRecognizing(true);
      window.setTimeout(() => onEmailSelected(selectedEmail), 360);
    }
  };
      ...
      >
        ...
        >
          ...
          <div className="text-center mb-8">
            ...
            <motion.div
              ...
              style={{
                background: previewOrg
                  ...
                  : 'var(--theme-gradient-btn, linear-gradient(135deg, #D4AF37, #8B7330))',
              }}
            ...
            <motion.h2
              className="text-[28px] md:text-[32px] mb-3 font-normal"
              style={{
                fontFamily: 'var(--theme-font-display, Cormorant Garamond, Georgia, serif)',
            ...
            <motion.p
              className="text-sm"
              style={{ color: 'var(--theme-text-secondary, #8A8578)' }}
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
          ...
          >
            ...
            <motion.button
              ...
              style={{
                background: previewOrg
                  ? previewOrg.theme.gradientBtn
                  : 'var(--theme-gradient-btn, linear-gradient(135deg, #8B7330, #D4AF37, #F4D03F))',
          ...
          >
            <p className="text-xs" style={{ color: 'var(--theme-text-muted, #B8B0A0)' }}>
